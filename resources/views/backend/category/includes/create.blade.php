<div class="modal" id="add_category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            ...
            <form action="{{ route('backend.category.store') }}" method="post">
                ...
                <div class="modal-body text-left">
                    @csrf
                        ...
                        <input class="form-control" id="message-text1" placeholder="Enter category Name" name="name" />
                        @if($errors->has('name'))
